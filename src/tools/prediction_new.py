...
class EnhancedMarketFactorAnalyzer:
    ...
    def analyze_market_trend(self, index_codes=["sh000001", "sz399001"]):
        """
        分析大盘趋势 - 多指数综合分析
        """
        try:
            ...
            for index_code in index_codes:
                index_name = "上证指数" if index_code == "sh000001" else "深证成指"
                ...
                market_analysis[index_name] = {
                    'is_main_uptrend': '主升浪' if is_main_uptrend else '震荡调整',
            ...
            if market_analysis:
                ...
                final_analysis = {
                    'overall_is_main_uptrend': '主升浪' if overall_uptrend else '震荡调整',
...
def main():
    ...
    STOCK_CONFIG = {
        ...
        "data_dir": r"D:\workspace\quantlab\Kronos\examples\data",
        "pred_days": 60,
        "output_dir": r"D:\workspace\quantlab\Kronos\examples\yuce",
        "history_years": 1
    }
